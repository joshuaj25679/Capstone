...
public class Locations
{
    ...
    public RDU RDU { get; set; }
    public LAX LAX { get; set; }
    public DCA DCA { get; set; }
    public DTW DTW { get; set; }
    public LGA LGA { get; set; }
    public SLC SLC { get; set; }
    public MSP MSP { get; set; }
    public DEN DEN { get; set; }
    public JFK JFK { get; set; }
    public SEA SEA { get; set; }
    public IAH IAH { get; set; }
    public CVG CVG { get; set; }
